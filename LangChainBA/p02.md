...
# Step 3: Build chain (NEW STYLE)
chain = prompt | llm

# Step 4: Run the chain
response = chain.invoke({"topic": "DNA sequencing"})
print(response.content)
...
# First step: explanation prompt
explain_prompt = PromptTemplate.from_template(
    "Explain {topic} in simple terms."
)

# Second step: quiz prompt
quiz_prompt = PromptTemplate.from_template(
    "Make 3 quiz questions from this explanation:\n{explanation}"
)

# NEW STYLE: build a sequential pipeline using pipe
overall_chain = explain_prompt | llm | quiz_prompt | llm

# Run the chain
response = overall_chain.invoke({"topic": "Blockchain technology"})
print(response.content)
