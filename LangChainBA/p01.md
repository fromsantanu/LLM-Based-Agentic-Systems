...
llm = ChatOpenAI(model="gpt-4.1-mini")  # or "gpt-4.1"

# Define prompt template
prompt = PromptTemplate.from_template(
    "What are three key health benefits of {exercise}?"
)
...
```
Three key health benefits of yoga are:

1. **Improved Flexibility and Strength**: Regular yoga practice helps increase muscle flexibility, tone, and overall body strength.

2. **Stress Reduction and Mental Clarity**: Yoga promotes relaxation through breathing techniques and meditation, reducing stress and enhancing mental focus.

3. **Better Cardiovascular Health**: Certain styles of yoga improve circulation, lower blood pressure, and support heart health.
```
